  ...
  return (
    <nav className="fixed top-0 left-0 w-full h-16 bg-white shadow-md z-50">
      <div className="max-w-7xl mx-auto px-4 flex items-center justify-between h-16">
        ...
        {/* Right Controls: Notifications and Profile / Sign In */}
        <div className="flex items-center gap-4">
          ...
          {isLoggedIn ? (
            <div className="relative group">
              <img
                src={profilePhoto || "https://smkdoss73.github.io/assets/img/testimonials/testimonials-1.jpg"}
                className="w-9 h-9 rounded-full border-2 border-blue-400 object-cover cursor-pointer"
                alt=""
              />

              {/* Profile Dropdown */}
              <div className="absolute right-0 mt-2 w-44 bg-white shadow-xl rounded-md py-2 opacity-0 group-hover:opacity-100 
                pointer-events-none group-hover:pointer-events-auto z-50 transition-opacity duration-200">
                {/* <a
                  href="/dashboard"
            ...
            <a
              href="/login"
              className="bg-blue-500 text-white px-4 py-2 rounded transition font-semibold hover:bg-blue-600"
            >
              Sign In
            </a>
          )}
