...
const vehicles = [
  {
    ...
    pricePerDay: 300,
    location: "Bangalore",
    imageUrl: "https://s3.cloud.cmctelecom.vn/tinhte2/2019/08/4747397_Yamaha_MT-15_2019_Xe_Tinhte_9.jpg",
  ...
  },
  {
    ...
    description: "Electric car with sleek design and long range.",
  },
  {
    id: 4,
    ...
    pricePerDay: 700,
    location: "Hyderabad",
    imageUrl: "https://media.assettype.com/freepressjournal/2024-08-13/yzph8wjx/Royal%20Enfiel%20Classic%20350",
    description: "Classic cruiser bike with comfortable riding.",
  },
];

export default function FeaturedVehiclesGrid({ vehiclesData }) {
  // Use passed vehiclesData or fallback to static sample vehicles
  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="grid gap-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
        {featuredVehicles.map(({ id, title, category, pricePerDay, location, imageUrl, description }) => (
          <div
            key={id}
          ...
          >
            ...
            <div className="p-4 flex flex-col flex-grow">
              ...
              <div className="mt-4 flex justify-between items-center">
                <span className="text-blue-600 font-bold">₹{pricePerDay}<small className="text-gray-500 font-normal"> / day</small></span>
                <a
                  href={`/vehicles/₹{id}`}
